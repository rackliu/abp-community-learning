...
revision_log:
  - version: "1.0"
    date: "2025-11-20"
    notes: "根據 V9.3 版本全面重寫，增加專案結構詳解與啟動流程圖"
---
...
在開始之前，請確保您的開發環境已滿足以下需求。ABP V9.3 基於最新的 .NET 技術堆疊。

### 必要工具

1.  **.NET 9.0 SDK**：

    - 下載連結：[https://dotnet.microsoft.com/download/dotnet/9.0](https://dotnet.microsoft.com/download/dotnet/9.0)
    - 驗證指令：`dotnet --version`
...
3.  **IDE (整合開發環境)**：
    ...
    - **Visual Studio 2022** (推薦 Windows 使用者，需更新至最新版以支援 .NET 9)。
...
4.  點擊 "Try it out" -> "Execute"，您將看到回應 "Hello from ABP V9.3!"。
